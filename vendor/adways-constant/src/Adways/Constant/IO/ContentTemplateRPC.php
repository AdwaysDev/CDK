...
//    const CONTENT_CONTEXT_VPAID_NON_LINEAR = 'vpaid_non_linear';   
    ...
    const CONTENT_STUDIO_UI_EDITOR_PREVIEW_PRESETS = 'presets';  
//    const CONTENT_STUDIO_UI_EDITOR_PREVIEW_PRESETS_FILE = 'FILE';  
    const CONTENT_STUDIO_UI_EDITOR_PREVIEW_PRESETS_PHONE_V = 'PHONE_V';  
    const CONTENT_STUDIO_UI_EDITOR_PREVIEW_PRESETS_PHONE_H = 'PHONE_H';  
    const CONTENT_STUDIO_UI_EDITOR_PREVIEW_PRESETS_TABLET_V = 'TABLET_V';  
    const CONTENT_STUDIO_UI_EDITOR_PREVIEW_PRESETS_TABLET_H = 'TABLET_H';  
    ...
    const CONTENT_STUDIO_UI_EDITOR_PREVIEW_PRESETS_CUSTOM_HEIGHT = 'WIDTH';  
