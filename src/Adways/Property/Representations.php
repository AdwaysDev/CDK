...
//	const SLIDER_V = ContentTemplateRPC::PROPERTY_REPRESENTATION_SLIDER_V;
	const SLIDER_H = ContentTemplateRPC::PROPERTY_REPRESENTATION_SLIDER_H;
	const BUTTON_PLUS_MINUS = ContentTemplateRPC::PROPERTY_REPRESENTATION_BUTTON_PLUS_MINUS;
